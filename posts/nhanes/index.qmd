...
```stata
use https://raw.githubusercontent.com/tphofer/ncsp-hhcr/refs/heads/main/data/nhanes_ncsp.dta
```
...
Below I reproduced age category by gender prevalence estimates using the nhanes-ncsp datset and the stata code folded below
```{stata, results="hide"}
...
* Define subpop  non-pregant persons >18, with one or more non-missing BPs in 2017-2019 cohort
gen include=(ridageyr>=18 & !missing(ridageyr)) & pregnant!=3 & (sys_no_miss!=0 | dia_no_miss!=0) & year==2017

svyset [w=wtmec2yr], psu(sdmvpsu) strata(sdmvstra) vce(linearized)
encode riagendr , gen(gender) label(gender)
replace new_htn=100 if new_htn==1
...
collect style cell result[_r_se], nformat(%5.2f) sformat("(%s)")
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
year         11891      2   2015.98      2015      2017  
seqn         11891  11891  93393.81     83732    102956  
ridageyr     11891     65  47.21882        16        80  
age_grp      11891      4   2.88218         1         4  
sddsrvyr     11891      2         .         .         .  
education    10724      5  3.476035         1         5  
dmdmartl     10739      7         .         .         .  
indfmpir     10495    487  2.446261         0         5  
ridreth3     11891      6         .         .         .  
riagendr     11891      2         .         .         .  
bpxsy1       10876     74  124.7269        72       236  
bpxsy2       11255     75  124.7012        72       238  
bpxsy3       11214     78  124.2804        72       238  
bpxsy4         737     62  134.1493        76       234  
bpxdi1       10806     55  70.52841        14       136  
bpxdi2       11195     57  70.62439        20       144  
bpxdi3       11156     59  70.55199         2       140  
bpxdi4         727     44  76.67125        30       132  
bmxbmi       11713    449  29.31031      13.2      86.2  
bpq050a       3620      2         .         .         .  
ridexprg      2297      3         .         .         .  
sdmvstra     11891     30  133.4681       119       148  
sdmvpsu      11891      2  1.501219         1         2  
wtmec2yr     11891   5411  21529.58         0  419762.8  
pregnant      2297      3  2.019155         1         3  
sys_no_miss  11891      4  2.866201         0         3  
dia_no_miss  11891      4  2.866201         0         3  
sys_mean     11421    237  124.8151  72.66666       238  
dia_mean     11421    190  70.30456         0  138.6667  
new_htn      11527      2  49.86553         0       100  
include      11891      2  .9000925         0         1  
gender       11891      2  1.482213         1         2  
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
